...
export const SPECIES = [
  ...
  { id: "belted-kingfisher",       commonName: "Belted Kingfisher",      scientificName: "Megaceryle alcyon",       mnemonic: "Loud rattling call" },
  ...
  { id: "lazuli-bunting",          commonName: "Lazuli Bunting",         scientificName: "Passerina amoena",        mnemonic: "Bright, jumpy warbling phrase" },
