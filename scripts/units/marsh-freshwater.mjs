...
export const SPECIES = [
  ...
  { id: "sora",                    commonName: "Sora",                   scientificName: "Porzana carolina",        mnemonic: "Descending whinny, plaintive 'ker-WEE'" },
  ...
  { id: "mallard",                 commonName: "Mallard",                scientificName: "Anas platyrhynchos",      mnemonic: "Classic descending quack" },
